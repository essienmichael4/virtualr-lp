...
const Features = () => {
  return (
    <div className="mt-20 relative border-b border-neutral-100/80 min-h-[800px]">
        <div className="text-center">
            <span className="text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase bg-neutral-100/80">Features</span>
